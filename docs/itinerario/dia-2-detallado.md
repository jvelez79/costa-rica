# Itinerario Detallado Día 2: Traslado a La Fortuna - Volcán Arenal y Aguas Termales

**Día:** Lunes 24 Noviembre 2025
**Tipo:** Traslado + Naturaleza + Relajación
**Ubicación:** San José → La Fortuna (Arenal)
**Nivel de actividad:** Medio-Alto
**Distancia conducción:** ~130 km (~3-3.5 horas)

[← Volver al resumen del Día 2](dia-2.md)
...
- Verificar factura
- Devolver llaves
- Confirmar que no dejamos nada en habitaciones
...
**Horario del parque:** 8:00 AM - 4:00 PM (última entrada)
**Entrada:**
- **Adultos:** $15 USD por persona
- **Total grupo 10:** $150 USD
- **Niños 2-12:** $5 USD (no aplica a nuestro grupo)
- **Pago:** Efectivo (USD o colones) o tarjeta

**Parking:**
- Gratuito en el parque
- Espacio amplio para ambos vehículos
- Seguro (área vigilada)

#### Estado Actual del Volcán

**⚠️ IMPORTANTE:**
- Volcán Arenal está **DORMIDO** desde octubre 2010
- **NO hay lava visible** (solo vapor ocasional)
- **Completamente seguro** para visitar
- Aguas termales siguen activas por actividad geotérmica subterránea

#### Senderos Disponibles

**Sendero 1: Las Coladas (1968 Trail)**
- **Distancia:** 3.4 km (ida y vuelta)
- **Duración:** 1.5-2 horas
- **Dificultad:** Moderada
- **Qué ver:**
  - Flujos de lava de erupción de 1968
  - Vistas del volcán Arenal
  - Lago Arenal a lo lejos
  - Vegetación en recuperación
- **Superficie:** Rocas volcánicas, puede ser irregular
- **Mejor para:** Ver de cerca los flujos de lava históricos

**Sendero 2: El Ceibo**
- **Distancia:** 2.1 km (loop)
- **Duración:** 1 hora
- **Dificultad:** Fácil-Moderada
- **Qué ver:**
  - Bosque tropical
  - Árbol Ceibo gigante (500+ años)
  - Fauna: aves, monos posibles
- **Superficie:** Sendero bien mantenido
- **Mejor para:** Quienes prefieren bosque vs. lava

**Sendero 3: Los Miradores (Lookout Points)**
- **Distancia:** Variable (múltiples miradores)
- **Duración:** 30 minutos - 1 hora
- **Dificultad:** Fácil
- **Qué ver:**
  - Vistas panorámicas del volcán
  - Lago Arenal
  - Excelente para fotos
- **Mejor para:** Quienes quieren vistas sin caminar mucho

#### Recomendación para Grupo de 10

**Opción A: Sendero Las Coladas (1968) - 2 horas**
- Más icónico y recomendado
- Ver los flujos de lava de 1968
- Mejor experiencia del parque

**Opción B: Combinación Miradores + El Ceibo - 1.5-2 horas**
- Menos exigente físicamente
- Ver bosque + vistas panorámicas
- Ideal si hay cansancio del viaje

**Opción C: Dividir grupo**
- Algunos hacen Las Coladas (más aventureros)
- Otros hacen Miradores + El Ceibo (más relajado)
- Coordinar hora de encuentro en parking
...
**Esencial:**
- 👟 **Botas de hiking impermeables** (senderos LODOSOS en noviembre)
...
**Recomendado:**
- ☂️ Poncho/impermeable ligero (lluvia probable 2-4 PM)
- 🍫 Snacks energéticos
- 🩹 Botiquín básico
- 📱 Celular cargado (fotos, GPS)

**Ropa:**
- Pantalones largos convertibles o deportivos
- Camiseta que respire (no algodón)
- Calcetines de hiking (evitar ampollas)

#### Servicios en el Parque

- ✅ Baños disponibles en entrada
- ✅ Agua potable en entrada
- ✅ Pequeña tienda de souvenirs
- ❌ NO hay restaurante (solo snacks básicos)
- ❌ NO hay servicio de guías oficiales en entrada (contratar antes si quieren)
...
- ✅ Parking amplio para ambos vehículos
...
### Opción 2: Tabacón Grand Spa 🌟 **PREMIUM/LUXURY**
**Precio:** $99 USD day pass (solo termales) | $168 USD (termales + 1 comida)
**Total grupo 10:** $990 USD (solo termales) | $1,680 USD (con comida)

**Ubicación:** 11 km al noroeste de La Fortuna
**Coordenadas:** 10.4833° N, 84.7167° W
...
- Casillero
- Estacionamiento
- Acceso a múltiples piscinas naturales en jardines exuberantes

**⚠️ CRÍTICO:**
- **REQUIERE RESERVA CON MESES DE ANTICIPACIÓN** (especialmente noviembre)
- Si quieren esta opción: **Reservar INMEDIATAMENTE**
- Se llena completamente

**Ventajas:**
- ✅ Resort de lujo, ambiente premium
- ✅ Piscinas naturales hermosas con cascadas
- ✅ Jardines tropicales exuberantes
- ✅ Restaurante de calidad
- ✅ Experiencia más exclusiva

**Desventajas:**
- ❌ Muy caro para grupo de 10
- ❌ Requiere reserva anticipada (no flexible)
- ❌ Puede estar ocupado igual que otras opciones

---

### Opción 3: Ecotermales Fortuna 🍃 **BOUTIQUE/ÍNTIMO**
**Precio:** ~$42-50 USD por persona
**Total grupo 10:** $420-500 USD (estimado)

**Horario:** Slots de día y noche (confirmar al reservar)

**Qué incluye:**
- Toallas
- Lockers
- Cambiadores
- Acceso a menos de 10 piscinas (diferentes temperaturas)
- Restaurante y bar en sitio
- Wristband para tab (no necesitas efectivo durante visita)

**Capacidad limitada:** 150 day pass + 150 evening pass

**Ventajas:**
- ✅ Ambiente más tranquilo/íntimo que Baldi
- ✅ Menos multitudes
- ✅ Caminos pavimentados (no resbaloso)
- ✅ Restaurante y bar (meseros traen a piscinas)
- ✅ Piscina con arena negra volcánica (experiencia única)

**Desventajas:**
- Menos piscinas que Baldi
- Más caro que Baldi sin incluir comida
- Capacidad limitada (puede requerir reserva)

---

### Opción 4: Aguas Termales GRATIS 💰 **BUDGET/AVENTURA**
**Precio:** GRATIS (solo parking ~$8-10 USD)
**Total grupo 10:** $8-10 USD total

**Ubicación:** Al lado del Tabacón Resort (literalmente next door)
**Acceso:** Lado de la carretera (dice "private property" pero es accesible)
**Horario:** Cualquier hora (24/7 técnicamente)

**Qué es:**
- Río de aguas termales naturales
- Corre a través de la jungla
- Calentado naturalmente por Volcán Arenal
- Múltiples piscinas naturales

**Qué incluye:**
- NADA - 100% natural
- Solo agua termal y naturaleza

**Ventajas:**
- ✅ Completamente GRATIS (solo parking $8-10)
- ✅ Experiencia natural/sin procesar
- ✅ "Feels so natural and so untouched"
- ✅ Inmersión total en selva tropical
- ✅ No requiere reserva (llegar y disfrutar)
- ✅ Si van tarde (cerca sunset), se vacía

**Desventajas:**
- ❌ Rocas resbalosas (riesgo de caídas)
- ❌ No hay lockers/cambiadores/infraestructura
- ❌ Tienes que cambiarte al lado de carretera
- ❌ No tan limpio como opciones pagadas
- ❌ No hay donde poner tus cosas (solo rocas)

**⚠️ TIP IMPORTANTE:**
- Usar traje de baño VIEJO o NEGRO (el agua puede cambiar color del traje)
- Llevar bolsa impermeable para cosas
- Llevar tu propia toalla
- Calzado con buen agarre
- Mejor ir más tarde en el día (menos gente)

**Mejor para:**
- Aventureros
- En presupuesto
- Les gusta lo natural
- No les importa falta de comodidades

---

### Opción 5: Termalitas del Arenal 💵 **ULTRA-BUDGET**
**Precio:** $8 USD por persona
**Total grupo 10:** $80 USD

**Característica:**
- Opción económica básica
- Menos conocida
- Piscinas termales sencillas

---

## Recomendación Final Aguas Termales
...
**Proceso de check-in:**
1. Llegar al Airbnb
2. Seguir instrucciones de entrada del anfitrión
3. Descargar equipaje de ambos vehículos
4. Distribuir habitaciones entre 10 personas
5. Familiarizarse con la casa
6. Preguntar/revisar:
   - WiFi password
   - Cómo funciona agua caliente
   - Ubicación de toallas
   - Normas de la casa
...
- ATV (cuatrimotos)
- Rafting Los Rápidos
- Posiblemente Cascada La Fortuna

**Checklist nocturno:**
- ✅ Configurar alarmas para mañana (7:00-7:30 AM)
- ✅ Verificar que tienen ropa adecuada lista:
  - Ropa que se puede mojar (ATV y rafting)
  - Zapatos con buen agarre (se mojarán)
  - Traje de baño bajo la ropa (rafting)
  - Ropa de cambio en mochila
- ✅ Cargar celulares, cámaras, power banks
- ✅ Verificar que tienen bloqueador solar y repelente
- ✅ Revisar confirmaciones de tours si ya reservaron
- ✅ Descansar bien (mañana día largo y activo)
...
### Para Aguas Termales
- [ ] Traje de baño
- [ ] Toalla (si no está incluida en la opción elegida)
- [ ] Sandalias
- [ ] Ropa cómoda para después
- [ ] Bolsa impermeable para celular/electrónicos
...
- **Probabilidad lluvia:** 81% diaria
- **Patrón típico:**
  - 7:00 AM - 1:00 PM: Despejado o parcialmente nublado
  - 2:00 PM - 4:00 PM: Lluvia (tormentas 1-3 horas)
...
- [← Día 1 Detallado](dia-1-detallado.md)
- [Día 3 - ATV + Rafting →](dia-3.md)

---

**¡Disfruten La Fortuna y el Volcán Arenal! 🌋♨️**
